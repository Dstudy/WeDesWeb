(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))r(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const i of t.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function r(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();class s extends HTMLElement{static get observedAttributes(){return["open"]}constructor(){super();const n=this.attachShadow({mode:"open"});n.innerHTML=`
  ...
  .menu-link:hover, .menu-link:focus-visible{ background:var(--hover-bg); color:var(--hover-fg); outline:none; }
      ...
      `,this._btn=n.querySelector(".menu-btn"),this._overlay=n.querySelector(".menu-overlay"),this._onKey=a=>{a.key==="Escape"&&(this.open=!1)},this._onClickLink=a=>{a.target.closest(".menu-link")&&(this.open=!1)}}connectedCallback(){this._btn.addEventListener("click",()=>this.open=!this.open),this._overlay.addEventListener("click",this._onClickLink),window.addEventListener("keydown",this._onKey)}disconnectedCallback(){this._overlay.removeEventListener("click",this._onClickLink),window.removeEventListener("keydown",this._onKey)}attributeChangedCallback(n,a,r){var t,i;if(n!=="open")return;const e=this.hasAttribute("open");(t=this._btn)==null||t.setAttribute("aria-expanded",String(e)),(i=this._overlay)==null||i.setAttribute("aria-hidden",String(!e)),document.body.style.overflow=e?"hidden":""}get open(){return this.hasAttribute("open")}set open(n){n?this.setAttribute("open",""):this.removeAttribute("open")}}customElements.define("overlay-menu",s);
