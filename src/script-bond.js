...
// Project titles
const items = [
  "WeDes tổ chức buổi sharing đầu tiên",
  "Tham quan PTIT",
  "Chị Dung và thằng đệ",
  "Chụp ảnh nhưng quạu",
  "Ngục tù tăm tối",
  "Chị Dung và áo chống nắng cute",
  "Chill hội làng Dương",
  "Ngục tù tăm tối v2",
  "Chúng mình cùng học",
  "Một buổi sinh nhật ý nghĩa",
  "Workshop đầu tiên",
  "Tác phẩm mô di ắc",
  "Đi ăn chè",
  "Tham quan kiến trúc",
  "Sinh nhật nè",
  "Gương thần",
  "WeDes check in triển lãm",
  "Năm mới đầy quà",
  "Quà nè",
  "Giáng sinh nhiều quà",
];
// Image URLs - replace with your actual image URLs

const base = import.meta.env.BASE_URL || "/"; // e.g. "/" in dev, "/WeDesWeb/" on GH Pages

const imageUrls = Array.from(
  { length: 20 },
  (_, i) => `${base}img/team${i + 1}.png`
);
